...
#define STRING_CONFIG_H_AUTHOR "Barnops" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BTT Ender-3 (Marlin 2.0.8.2)"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  33.85,  33.85 }
    #define DEFAULT_Ki_LIST {   4.38,   4.38 }
    #define DEFAULT_Kd_LIST {  65.33,  65.33 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 138.43 }
